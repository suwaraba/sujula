...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    /**
     * Order items not yet dispatched from the vendor's premises: those whose
     * VendorOrder status is in the supplied set (PENDING/CONFIRMED/PROCESSING),
     * plus items that have no VendorOrder at all (even more outstanding).
